...
tasks.named<ProcessResources>("processResources") {
    ...
    val props = HashMap<String, String>().apply {
        ...
        this["fabric_api_version"] = if (hasProp("deps.min-fabric-api")) prop("deps.min-fabric-api") else prop("deps.fabric-api")
...
// net.mehvahdjukaar:codecui-fabric:<mc>-<modversion>. Local installs go through publishToMavenLocal;
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            artifactId = "${property("mod.archives_base")}-fabric"
